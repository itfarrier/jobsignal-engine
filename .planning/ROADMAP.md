...
- [x] 03-01-PLAN.md — Baseline Metrics Airtable schema + CSV template + setup docs
- [x] 03-02-PLAN.md — TDD: parse-runData parser for n8n execution metrics
...
| 3. Baseline Diagnosis | v2.1 | 2/3 | In Progress|  |
