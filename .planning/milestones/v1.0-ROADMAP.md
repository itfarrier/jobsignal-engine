...
- [x] 01-01-PLAN.md — Airtable schema docs: RU geographies, HH RSS columns, Pipeline Source `hh.ru` (HH-07, HH-08)
- [x] 01-02-PLAN.md — `01e-scanner-hhru.json` workflow, parse fixture/script, SETUP.md (HH-01–HH-06, HH-09)
